...
class _Love_ScreenState extends State<Love_Screen> {
  ...
  forGetVariable() async {
    ...
    bool? isLoveArrived = prefs.getBool('loveArrived') ?? false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Love Quotes",style: TextStyle(color: Colors.white,fontSize: 22),),
        centerTitle: true,
  ...
  isDataArrived() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setBool('loveArrived', true);
  }
