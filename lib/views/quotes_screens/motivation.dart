...
class Motivation_Screen extends StatefulWidget {
  const Motivation_Screen({Key? key}) : super(key: key);

  @override
  State<Motivation_Screen> createState() => _Motivation_ScreenState();
}

class _Motivation_ScreenState extends State<Motivation_Screen> {
