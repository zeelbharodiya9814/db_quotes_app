...
class Life_Screen extends StatefulWidget {
  const Life_Screen({Key? key}) : super(key: key);

  @override
  State<Life_Screen> createState() => _Life_ScreenState();
}

class _Life_ScreenState extends State<Life_Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Life Quotes",style: TextStyle(color: Colors.white,fontSize: 22),),
        centerTitle: true,
  ...
  isDataArrived() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setBool('LifeArrived', true);
  }
